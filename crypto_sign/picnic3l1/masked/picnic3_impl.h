...
/* A structure to hold a t-sharing of the private key.  For now, key generation and the higher layers
 * work with an unshared version, we share it in impl_sign_picnic3.  Ideally, key
 * generation would also work with t-shares and the private keys is never reconstructed.
*/
typedef masked_uint8_t masked_private_key_t; 
